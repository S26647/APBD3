...
public static class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        shipsList.Add(new ContainerShip("Ship 1",10, 10, 10));
        ...
        while (true)
        {
            ...
            switch (command)
            {
                ...
                case "ac":
                    ...
                    switch (command)
                    {
                        ...
                        case "G":
                            ...
                            break;
                        case "C":
                            Console.WriteLine("Enter maxLoad, height, weight, depth, product, container temperature");
                ...
                case "us":
                    ...
                    foreach (var container in ship.ContainersList) { containersList.Add(container); }
